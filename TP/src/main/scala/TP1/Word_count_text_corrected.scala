...
object Word_count_text_corrected {
  ...
  def main(args: Array[String]): Unit = {
     ...
     * Now sum the Iterable using a `map()` transformation. The result should be a pair RDD consisting of (word, count) pairs.
     */
     ...
     * Define the function removePunctuation that converts all text to lower case, removes any punctuation, and removes leading and trailing spaces.
     *
     * To complete this task, you should use implemented functions such as :
     *
     ...
     *
     * You should also use the trim and lower functions found in [spark.sql.functions] in order to lower text and remove leading and trailing spaces.
     *
